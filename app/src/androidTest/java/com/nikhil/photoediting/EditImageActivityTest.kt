...
class EditImageActivityTest {
    ...
    fun checkIfPinchTextScalableFlagWorks_False() {
        ...
        Thread.sleep(1000)
        Espresso.onView(ViewMatchers.withId(ja.nikhil.photoeditor.R.id.frmBorder)).perform(ViewActions.click())

        // Capture the scale of the emoji
        var emojiFrameParentView =
            mActivityRule.activity.findViewById<View>(ja.nikhil.photoeditor.R.id.frmBorder).parent as ViewGroup
        ...
        Espresso.onView(ViewMatchers.withId(ja.nikhil.photoeditor.R.id.frmBorder)).perform(PinchTestHelper.pinchOut())
        ...
        Espresso.onView(ViewMatchers.withId(ja.nikhil.photoeditor.R.id.imgPhotoEditorClose)).perform(ViewActions.click())
        ...
        // Select the text box
        val testTextBox = ViewMatchers.withId(ja.nikhil.photoeditor.R.id.tvPhotoEditorText)
    ...
    fun checkIfOnlyOneStickerCanBeSelectedAtATime() {
        ...
        val firstEmojiStickerFrameBorder = mActivityRule.activity.findViewById<View>(ja.nikhil.photoeditor.R.id.frmBorder)
        ...
        Espresso.onView(withIndex(ViewMatchers.withId(ja.nikhil.photoeditor.R.id.frmBorder), 0))
        ...
        Espresso.onView(withIndex(ViewMatchers.withId(ja.nikhil.photoeditor.R.id.frmBorder), 1))
            .check { view: View, noViewFoundException: NoMatchingViewException? ->
                assertNotNull(
                    null,
                    view.background
